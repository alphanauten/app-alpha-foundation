...
class MarketingBannerDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new StringField('banner_condition', 'bannerCondition'))->addFlags(new Required(), new ApiAware()),
            (new ListField('categories', 'categories'))->addFlags(new ApiAware()),
            (new ListField('property_group_options', 'propertyGroupOptions'))->addFlags(new ApiAware()),
